    ...
    >
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 min-[900px]:grid-cols-2 gap-[1.75rem]">
          <Reveal id="site-vitrine" delay={0}>
            <div className="card card-numbered card-sunshine">
              ...
              <p>
                Pour présenter ton activité, attirer des prospects, asseoir ta crédibilité en ligne.
                3 à 5 pages adaptées à tous les écrans, bien référencées sur Google, hébergement
          ...
          <Reveal id="site-vitrine-cms" delay={80}>
            <div className="card card-numbered card-peach">
          ...
          <Reveal id="application-web" delay={160}>
            <div className="card card-numbered card-mint">
              ...
              <p>
                ...
                : cadrage, design, développement, mise en ligne et suivi. Les technologies sont
                choisies selon ton besoin.
              </p>
              <ul className="card-list">
          ...
          <Reveal id="automatisation-n8n" delay={240}>
          ...
          <Reveal id="ia" delay={320}>
            <div className="card card-numbered card-peach">
              ...
              <p>
                ...
                tri d&apos;informations. C&apos;est ce qui fait tourner mon média de veille
                watch·ia.
              </p>
              <ul className="card-list">
